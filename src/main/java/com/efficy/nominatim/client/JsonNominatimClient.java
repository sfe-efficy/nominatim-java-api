package com.efficy.nominatim.client;
...
import com.efficy.nominatim.client.request.NominatimLookupRequest;
import com.efficy.nominatim.client.request.NominatimReverseRequest;
import com.efficy.nominatim.client.request.NominatimSearchRequest;
import com.efficy.nominatim.gson.ArrayOfAddressElementsDeserializer;
import com.efficy.nominatim.gson.ArrayOfPolygonPointsDeserializer;
import com.efficy.nominatim.gson.BoundingBoxDeserializer;
...
import com.efficy.nominatim.client.request.paramhelper.OsmType;
import com.efficy.nominatim.gson.PolygonPointDeserializer;
import com.efficy.nominatim.model.Address;
import com.efficy.nominatim.model.Element;
import com.efficy.nominatim.model.BoundingBox;
import com.efficy.nominatim.model.PolygonPoint;
...
public final class JsonNominatimClient implements NominatimClient {
     ...
     * {@inheritDoc}
     * 
     * @see NominatimClient#search(NominatimSearchRequest)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see NominatimClient#getAddress(NominatimReverseRequest)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see NominatimClient#lookupAddress(NominatimLookupRequest)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see NominatimClient#search(java.lang.String)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see NominatimClient#getAddress(double, double)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see NominatimClient#getAddress(double, double, int)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see NominatimClient#getAddress(int, int)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see NominatimClient#getAddress(String, long)
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @see NominatimClient#lookupAddress(java.util.List)
     */
    @Override
